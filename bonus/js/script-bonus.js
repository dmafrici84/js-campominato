...
while (gradoDifficolta1 == false && j < 5) {
  ...
  var gradoDifficolta = prompt("Scrivi il grado di dificoltà del gioco: Principiante, Intermedio, Esperto");

  // trasformo tutte le lettere del gradoDifficolta in lettere maiuscole
...
var numElementiMax = livello;
console.log("numElementiMax", numElementiMax);
